...
export default function RotateToolbar({ documentId }: { documentId: string }) {
  ...
  return (
    <div className="bg-[#0c0c0c] rounded-lg shadow-lg z-10 absolute bottom-0 right-0 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center gap-2 p-2">
